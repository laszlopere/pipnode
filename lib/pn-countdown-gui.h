...
#ifndef PN_COUNTDOWN_GUI_H
#define PN_COUNTDOWN_GUI_H
 ...
 * registered #PnCountdown class.  Called once at editor startup (via
 ...
 * Countdown logic runs without GTK while the editor still paints the
 * display.  */
void pn_countdown_gui_install (void);

G_END_DECLS

#endif /* PN_COUNTDOWN_GUI_H */

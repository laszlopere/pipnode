...
/* Geometry of the pennant, in world px.  The height matches the
 * canonical node header so a flag lines up with the port row of the node
 * it is wired to.  PN_JUMP_POINT is the depth of the triangular tip that
 * gives the shape its direction; the tip is where the wire attaches. */
#define PN_JUMP_HEIGHT        30.0
#define PN_JUMP_POINT         12.0
#define PN_JUMP_PADDING       10.0
#define PN_JUMP_MIN_WIDTH     60.0
 ...
 * @out_width:  (out) (optional): pennant width in world px
 * @out_height: (out) (optional): pennant height in world px
 *

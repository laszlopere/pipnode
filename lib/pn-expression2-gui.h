...
#ifndef PN_EXPRESSION2_GUI_H
#define PN_EXPRESSION2_GUI_H
 ...
 * expression editor tab) onto the already-registered #PnExpression2
 ...
 * two-input expression evaluation logic runs without GTK.  */
void pn_expression2_gui_install (void);

G_END_DECLS

#endif /* PN_EXPRESSION2_GUI_H */
